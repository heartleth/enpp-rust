...
pub fn parse_repeat(tree :&Mem, pivot :usize)->Result<String, &'static str> {
...
#[inline]
pub fn parse_while(tree :&Mem, pivot :usize)->Result<String, &'static str> {
    Ok(format!("while ({}) {{\n{scope}}}\n",
...
pub fn parse_for(tree :&Mem, pivot :usize)->Result<String, &'static str> {
